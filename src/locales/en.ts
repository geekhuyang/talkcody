...
const en: LocaleDefinition = {
  ...
  Settings: {
    ...
    qwenOAuth: {
      ...
      description: 'Use Qwen Code OAuth token for authentication',
      tokenPathLabel: 'Token File Path',
      pathPlaceholder: '/path/to/qwen/code/token',
      browseTitle: 'Select Qwen Code Token File',
      testConnection: 'Test Connection',
      testing: 'Testing...',
      connected: 'Connected to Qwen Code',
      disconnect: 'Disconnect',
      disconnected: 'Disconnected from Qwen Code',
      pathRequired: 'Please enter token file path',
      fileNotFound: 'Token file not found',
      invalidToken: 'Invalid token format',
      testFailed: 'Connection test failed. Please check your token file.',
      disconnectFailed: 'Failed to disconnect',
      helpText:
        'Qwen Code stores its OAuth token locally. Please specify the path to your token file.',
      tokenPath: 'Current token path',
